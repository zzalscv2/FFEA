...
ffea_tools = 	{
		...
		"extractnodes": "FFEA_analysis/FFEA_traj_extract_position_data/FFEA_extract_specific_nodes",
		"trajtoxyz": "FFEA_analysis/FFEA_traj_extract_position_data/FFEA_extract_positions",
		"xyztodx": "FFEA_analysis/FFEA_traj_extract_position_data/Dx_convert_from_xyz_position_trajectory.py",
		"cgsurf": "FFEA_initialise/Surface_tools/surface_coarse_grainer/surface_coarse_grainer_final",
		"comparemodes": "FFEA_analysis/PCA/compare_modes/compare_modes.py",
