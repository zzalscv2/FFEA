...
scalar BEM_Poisson_Boltzmann::self_term(vector3 *n0, vector3 *n1, vector3 *n2, int precision) {
    ...
    vector3 r_01, r_02, r_12;
    r_01.data = {n1->x - n0->x, n1->y - n0->y, n1->z - n0->z},
    r_02.data = {n2->x - n0->x, n2->y - n0->y, n2->z - n0->z},
    r_12.data = {n2->x - n1->x, n2->y - n1->y, n2->z - n1->z};
    ...
    vector3 r_0_perp;
    r_0_perp.data = {r_01.x - r_01_dot_r_12 * r_12.x / r_12_sq,
