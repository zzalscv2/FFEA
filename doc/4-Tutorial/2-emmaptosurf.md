...
![The electron density structure of EMDB ID:EMD-5043 post-processing (contour level 1.15).](emd5043_processed_both.png "GroEL Electron Microscopy Structure")
