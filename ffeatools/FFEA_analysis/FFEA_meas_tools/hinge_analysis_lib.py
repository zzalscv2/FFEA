...
def plot_angle_distribution(bin_list, value_list, label_list, ticktype_list, filename="angle_distribution.pdf", norm=True):
    """
...
def auto():
    ...
    plot_angle_distribution([source_bins, destination_bins, experimental_bins], [source_values, destination_values, experimental_values], ["Atomistic MD with AMBER", "Elastic rod simulation", "Experimental data"], ["-", "--", "-."])
